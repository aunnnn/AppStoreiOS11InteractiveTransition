...
## Overview
All is done with native APIs (`UIViewControllerAnimatedTransitioning`, etc.), no external libraries. This is **not** a library to install or use, it's an experiementation/demo project to show how such App Stoe presentation might work.
